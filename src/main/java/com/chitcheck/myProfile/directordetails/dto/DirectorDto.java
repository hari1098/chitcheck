...
public class DirectorDto {
    ...
    public DirectorDto(Integer id, String name, String pancard, String aadharCard, String directorType, LocalDate joinDate, String email, String mobileNo, String address) {
        this.id = id;
        this.name = name;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, pancard, aadharCard, directorType, joinDate, email, mobileNo, address);
    }
}